...
plot(Quercuss_tree, cex=.8, label.offset =.1, no.margin = TRUE) #big tree of all sorts of trees - needs good trimming!
...
intersect(as.character(Quercus3sp_tree$tip.label), Quercus3sp) # all matching, but we changed the species name in teh list, so it will no longer match the original dataset
