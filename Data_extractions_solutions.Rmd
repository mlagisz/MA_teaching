...
**ANSWER 5:**    
CohortID is used to indicate that the same cohorts/group of animals, of different sex (F, M), were measured repeatedly at different ages (60 and 120). These are not independent data points, and this is captured by CohortID.   
...
**ANSWER 10:**    
Ideally, two people would be extracting the data in parallel 9independently, in-duplicate), to minimise errors. However it is often not practical. In such case one person could be extracting and another person checking the extractions (there are always mistakes!).
