...
**ANSWER 4:**    
 1. Non-informative column names (which group should be nr 1 ?)   
...
**ANSWER 5:**    
CohortID is used to indicate that the same cohorts/group of animals, of different sex (F, M), were measured repeatedly at different ages (60 and 120). These are not independent data points, and this is captured by CohortID. For different study question this could be an unique identifier of various study sites or populations that need tp be distinguished within and between studies.      
