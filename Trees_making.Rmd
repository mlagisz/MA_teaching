...
write.tree(tree, file="tree_curtis1998.tre") #save the tree
# tree <- read.tree(file="tree_curtis1998.tre") #if you need to read it
```
...
# tree_random <- read.tree(file="tree_curtis1998_random.tre") #if you need to read it
```
